...
{
    public struct SimpleDictionaryGraph<TNode, TEdge> : IEditableGraph<TNode, TEdge>, IGraph<TNode, TEdge> where TEdge : IEdge<TNode> where TNode : IEquatable<TNode>, IIDHolder
    {
